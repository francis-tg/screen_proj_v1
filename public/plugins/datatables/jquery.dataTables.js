...
(function (factory) {
  ...
  function _fnLanguageCompat(lang) {
    ...
    if (lang) {
      ...
      if (
        !lang.sEmptyTable &&
        zeroRecords &&
        defaults.sEmptyTable === "Aucune donnée n'est disponible... "
      ) {
  ...
  function _fnFilterComplete(oSettings, oInput, iForce) {
    ...
    _fnCallbackFire(oSettings, null, "search", [oSettings]); /*modifier*/
  }
  ...
  DataTable.defaults = {
    ...
    oLanguage: {
       ...
       */
      sSearchPlaceholder: "Entrer le mot clé...",
       ...
       *    } );
       */
      sZeroRecords: "Auccun produit retrouvé",
    },
