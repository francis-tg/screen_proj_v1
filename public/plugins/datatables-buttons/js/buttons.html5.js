...
(function(factory) {
    ...
    DataTable.ext.buttons.copyHtml5 = {
        ...
        text: function(dt) {
            return dt.i18n('buttons.copy', 'Copier');
        },
        ...
        action: function(e, dt, button, config) {
            ...
            var message = $('<span>' + dt.i18n('buttons.copyKeys',
                    'Press <i>ctrl</i> or <i>\u2318</i> + <i>C</i> Données copié<br>Ils sont dans le presse papier.<br><br>' +
                    'To cancel, click this message or press escape.') + '</span>')
                .append(hiddenDiv);

            dt.buttons.info(dt.i18n('buttons.copyTitle', 'Copier'), message, 0);
